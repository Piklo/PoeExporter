...
/// <summary>
/// Class used to export Blight lua data.
/// </summary>
internal sealed class BlightExporter
{
    private readonly SpecificationWrapper specificationWrapper;
    private readonly ILogger logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="BlightExporter"/> class.
    /// </summary>
    /// <param name="specificationWrapper">specification wrapper.</param>
    /// <param name="logger">logger.</param>
    public BlightExporter(SpecificationWrapper specificationWrapper, ILogger logger)
    {

...
/// </summary>
public sealed partial class DialogueEventDat : ISpecificationFile<DialogueEventDat>
{
    ...
    /// <inheritdoc/>
    public static DialogueEventDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DialogueEvent.dat64");

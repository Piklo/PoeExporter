...
/// </summary>
public sealed partial class ShopPaymentPackageDat : ISpecificationFile<ShopPaymentPackageDat>
{
    ...
    public static ShopPaymentPackageDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ShopPaymentPackage.dat64");

...
/// </summary>
public sealed partial class MicrotransactionRecycleSalvageValuesDat : ISpecificationFile<MicrotransactionRecycleSalvageValuesDat>
{
    ...
    public static MicrotransactionRecycleSalvageValuesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MicrotransactionRecycleSalvageValues.dat64");

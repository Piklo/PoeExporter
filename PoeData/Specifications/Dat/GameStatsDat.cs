...
/// </summary>
public sealed partial class GameStatsDat : ISpecificationFile<GameStatsDat>
{
    ...
    /// <inheritdoc/>
    public static GameStatsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GameStats.dat64");

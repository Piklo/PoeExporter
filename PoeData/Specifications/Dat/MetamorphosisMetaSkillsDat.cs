...
/// </summary>
public sealed partial class MetamorphosisMetaSkillsDat : IDat<MetamorphosisMetaSkillsDat>
{
    ...
    public static MetamorphosisMetaSkillsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MetamorphosisMetaSkills.dat64");
        ...
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            // loading SkillType
            (var skilltypeLoading, offset) = SpecificationFileLoader.LoadForeignRowPrimaryKey(decompressedFile, offset, dataOffset);

...
/// <summary>
/// Class containing HarvestSpecialCraftCosts.dat data.
/// </summary>
public sealed partial class HarvestSpecialCraftCostsDat : ISpecificationFile<HarvestSpecialCraftCostsDat>
{
    ...
    public static HarvestSpecialCraftCostsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestSpecialCraftCosts.dat64");

...
/// </summary>
public sealed partial class ZanaLevelsDat : ISpecificationFile<ZanaLevelsDat>
{
    ...
    /// <inheritdoc/>
    public static ZanaLevelsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ZanaLevels.dat64");

...
/// </summary>
public sealed partial class MultiPartAchievementConditionsDat : ISpecificationFile<MultiPartAchievementConditionsDat>
{
    ...
    public static MultiPartAchievementConditionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MultiPartAchievementConditions.dat64");

...
/// </summary>
public sealed partial class NPCFollowerVariationsDat : IDat<NPCFollowerVariationsDat>
{
    ...
    /// <inheritdoc/>
    public static NPCFollowerVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/NPCFollowerVariations.dat64");
        ...
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            (var miscanimatedkey0Loading, offset) = SpecificationFileLoader.LoadForeignRowPrimaryKey(decompressedFile, offset, dataOffset);

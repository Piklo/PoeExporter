...
/// </summary>
public sealed partial class ItemVisualIdentityDat : ISpecificationFile<ItemVisualIdentityDat>
{
    ...
    public static ItemVisualIdentityDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ItemVisualIdentity.dat64");

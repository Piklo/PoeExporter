...
/// </summary>
public sealed partial class DeliriumStashTabLayoutDat : ISpecificationFile<DeliriumStashTabLayoutDat>
{
    ...
    /// <inheritdoc/>
    public static DeliriumStashTabLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DeliriumStashTabLayout.dat64");

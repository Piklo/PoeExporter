...
/// </summary>
public sealed partial class ShopTokenDat : ISpecificationFile<ShopTokenDat>
{
    ...
    /// <inheritdoc/>
    public static ShopTokenDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ShopToken.dat64");

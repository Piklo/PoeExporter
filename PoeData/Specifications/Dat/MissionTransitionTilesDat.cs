...
/// </summary>
public sealed partial class MissionTransitionTilesDat
{
    ...
    /// <returns>array of MissionTransitionTilesDat.</returns>
    internal static MissionTransitionTilesDat[] Load(DataLoader dataLoader)
    {

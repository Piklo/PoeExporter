...
/// </summary>
public sealed partial class AchievementItemsDat : ISpecificationFile<AchievementItemsDat>
{
    ...
    /// <inheritdoc/>
    public static AchievementItemsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AchievementItems.dat64");

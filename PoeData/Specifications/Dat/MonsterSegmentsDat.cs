...
/// </summary>
public sealed partial class MonsterSegmentsDat : ISpecificationFile<MonsterSegmentsDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterSegmentsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterSegments.dat64");

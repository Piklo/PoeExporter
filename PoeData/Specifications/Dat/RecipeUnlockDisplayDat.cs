...
/// </summary>
public sealed partial class RecipeUnlockDisplayDat : ISpecificationFile<RecipeUnlockDisplayDat>
{
    ...
    public static RecipeUnlockDisplayDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/RecipeUnlockDisplay.dat64");

...
/// </summary>
public sealed partial class GroundEffectTypesDat : ISpecificationFile<GroundEffectTypesDat>
{
    ...
    public static GroundEffectTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GroundEffectTypes.dat64");

...
/// </summary>
public sealed partial class DancesDat : ISpecificationFile<DancesDat>
{
    ...
    /// <inheritdoc/>
    public static DancesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Dances.dat64");

...
/// </summary>
public sealed partial class IncursionChestsDat : ISpecificationFile<IncursionChestsDat>
{
    ...
    /// <inheritdoc/>
    public static IncursionChestsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/IncursionChests.dat64");

...
/// </summary>
public sealed partial class HarvestCraftOptionsDat : ISpecificationFile<HarvestCraftOptionsDat>
{
    ...
    /// <inheritdoc/>
    public static HarvestCraftOptionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestCraftOptions.dat64");

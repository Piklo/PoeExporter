...
/// </summary>
public sealed partial class SkillTrapVariationsDat : ISpecificationFile<SkillTrapVariationsDat>
{
    ...
    public static SkillTrapVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/SkillTrapVariations.dat64");

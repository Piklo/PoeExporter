...
/// </summary>
public sealed partial class BetrayalFortsDat : ISpecificationFile<BetrayalFortsDat>
{
    ...
    /// <inheritdoc/>
    public static BetrayalFortsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BetrayalForts.dat64");

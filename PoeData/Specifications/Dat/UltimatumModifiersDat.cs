...
/// </summary>
public sealed partial class UltimatumModifiersDat : ISpecificationFile<UltimatumModifiersDat>
{
    ...
    public static UltimatumModifiersDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/UltimatumModifiers.dat64");

...
/// </summary>
public sealed partial class QuestStaticRewardsDat : ISpecificationFile<QuestStaticRewardsDat>
{
    ...
    public static QuestStaticRewardsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/QuestStaticRewards.dat64");

...
/// </summary>
public sealed partial class TutorialDat : ISpecificationFile<TutorialDat>
{
    ...
    /// <inheritdoc/>
    public static TutorialDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Tutorial.dat64");

...
/// </summary>
public sealed partial class PerandusGuardsDat : ISpecificationFile<PerandusGuardsDat>
{
    ...
    /// <inheritdoc/>
    public static PerandusGuardsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PerandusGuards.dat64");

...
/// </summary>
public sealed partial class BlightEncounterTypesDat : ISpecificationFile<BlightEncounterTypesDat>
{
    ...
    public static BlightEncounterTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightEncounterTypes.dat64");

...
/// <summary>
/// Class containing DelveFlares.dat data.
/// </summary>
public sealed partial class DelveFlaresDat : ISpecificationFile<DelveFlaresDat>
{
    ...
    /// <inheritdoc/>
    public static DelveFlaresDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DelveFlares.dat64");
        ...
        var objects = new DelveFlaresDat[tableRows];

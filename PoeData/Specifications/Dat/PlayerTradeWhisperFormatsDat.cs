...
/// </summary>
public sealed partial class PlayerTradeWhisperFormatsDat
{
    ...
    /// <returns>array of PlayerTradeWhisperFormatsDat.</returns>
    internal static PlayerTradeWhisperFormatsDat[] Load(DataLoader dataLoader)
    {

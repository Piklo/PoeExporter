...
/// </summary>
public sealed partial class MonsterMapDifficultyDat : ISpecificationFile<MonsterMapDifficultyDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterMapDifficultyDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterMapDifficulty.dat64");

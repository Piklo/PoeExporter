...
/// </summary>
public sealed partial class IncursionArchitectDat : IDat<IncursionArchitectDat>
{
    ...
    /// <inheritdoc/>
    public static IncursionArchitectDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/IncursionArchitect.dat64");

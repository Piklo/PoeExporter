...
public sealed partial class AtlasPassiveSkillTreeGroupTypeDat : ISpecificationFile<AtlasPassiveSkillTreeGroupTypeDat>
{
    ...
    /// <inheritdoc/>
    public static AtlasPassiveSkillTreeGroupTypeDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AtlasPassiveSkillTreeGroupType.dat64");

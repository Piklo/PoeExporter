...
/// <summary>
/// Class containing NPCAudio.dat data.
/// </summary>
public sealed partial class NPCAudioDat : ISpecificationFile<NPCAudioDat>
{
    ...
    /// <summary> Gets VolumePercentage.</summary>
    public required int VolumePercentage { get; init; }
    ...
    public static NPCAudioDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/NPCAudio.dat64");

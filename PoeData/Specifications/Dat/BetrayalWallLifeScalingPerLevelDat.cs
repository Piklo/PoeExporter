...
/// </summary>
public sealed partial class BetrayalWallLifeScalingPerLevelDat : ISpecificationFile<BetrayalWallLifeScalingPerLevelDat>
{
    ...
    public static BetrayalWallLifeScalingPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BetrayalWallLifeScalingPerLevel.dat64");

...
/// </summary>
public sealed partial class CurrencyStashTabLayoutDat : ISpecificationFile<CurrencyStashTabLayoutDat>
{
    ...
    public static CurrencyStashTabLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/CurrencyStashTabLayout.dat64");

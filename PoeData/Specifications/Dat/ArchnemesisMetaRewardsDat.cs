...
/// </summary>
public sealed partial class ArchnemesisMetaRewardsDat : ISpecificationFile<ArchnemesisMetaRewardsDat>
{
    ...
    public static ArchnemesisMetaRewardsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ArchnemesisMetaRewards.dat64");

...
/// </summary>
public sealed partial class TerrainPluginsDat : ISpecificationFile<TerrainPluginsDat>
{
    ...
    /// <inheritdoc/>
    public static TerrainPluginsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/TerrainPlugins.dat64");

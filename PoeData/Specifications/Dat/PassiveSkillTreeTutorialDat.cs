...
/// </summary>
public sealed partial class PassiveSkillTreeTutorialDat : ISpecificationFile<PassiveSkillTreeTutorialDat>
{
    ...
    /// <inheritdoc/>
    public static PassiveSkillTreeTutorialDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PassiveSkillTreeTutorial.dat64");

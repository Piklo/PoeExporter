...
/// </summary>
public sealed partial class PerandusChestsDat : IDat<PerandusChestsDat>
{
    ...
    /// <inheritdoc/>
    public static PerandusChestsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PerandusChests.dat64");

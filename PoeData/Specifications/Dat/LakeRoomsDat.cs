...
/// </summary>
public sealed partial class LakeRoomsDat : ISpecificationFile<LakeRoomsDat>
{
    ...
    /// <inheritdoc/>
    public static LakeRoomsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/LakeRooms.dat64");

...
/// </summary>
public sealed partial class ExpeditionBalancePerLevelDat
{
    ...
    /// <returns>array of ExpeditionBalancePerLevelDat.</returns>
    internal static ExpeditionBalancePerLevelDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class LakeMetaOptionsUnlockTextDat
{
    ...
    /// <returns>array of LakeMetaOptionsUnlockTextDat.</returns>
    internal static LakeMetaOptionsUnlockTextDat[] Load(DataLoader dataLoader)
    {

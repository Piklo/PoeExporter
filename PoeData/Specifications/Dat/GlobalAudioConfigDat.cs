...
/// </summary>
public sealed partial class GlobalAudioConfigDat : ISpecificationFile<GlobalAudioConfigDat>
{
    ...
    /// <inheritdoc/>
    public static GlobalAudioConfigDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GlobalAudioConfig.dat64");

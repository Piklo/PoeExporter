...
/// </summary>
public sealed partial class HeistRoomsDat : IDat<HeistRoomsDat>
{
    ...
    /// <inheritdoc/>
    public static HeistRoomsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistRooms.dat64");

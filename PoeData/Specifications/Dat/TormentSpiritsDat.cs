...
/// </summary>
public sealed partial class TormentSpiritsDat : ISpecificationFile<TormentSpiritsDat>
{
    ...
    /// <inheritdoc/>
    public static TormentSpiritsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/TormentSpirits.dat64");

...
/// </summary>
public sealed partial class SkillArtVariationsDat : ISpecificationFile<SkillArtVariationsDat>
{
    ...
    /// <inheritdoc/>
    public static SkillArtVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/SkillArtVariations.dat64");

...
/// </summary>
public sealed partial class MiscAnimatedArtVariationsDat : ISpecificationFile<MiscAnimatedArtVariationsDat>
{
    ...
    public static MiscAnimatedArtVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MiscAnimatedArtVariations.dat64");

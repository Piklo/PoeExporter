...
/// </summary>
public sealed partial class TableMonsterSpawnersDat
{
    ...
    /// <returns>array of TableMonsterSpawnersDat.</returns>
    internal static TableMonsterSpawnersDat[] Load(DataLoader dataLoader)
    {

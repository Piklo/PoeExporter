...
/// </summary>
public sealed partial class HeistChestRewardTypesDat : ISpecificationFile<HeistChestRewardTypesDat>
{
    ...
    /// <inheritdoc/>
    public static HeistChestRewardTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistChestRewardTypes.dat64");

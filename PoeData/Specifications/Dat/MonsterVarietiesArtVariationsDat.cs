...
/// </summary>
public sealed partial class MonsterVarietiesArtVariationsDat : ISpecificationFile<MonsterVarietiesArtVariationsDat>
{
    ...
    public static MonsterVarietiesArtVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterVarietiesArtVariations.dat64");

...
/// </summary>
public sealed partial class HeistObjectivesDat : ISpecificationFile<HeistObjectivesDat>
{
    ...
    /// <inheritdoc/>
    public static HeistObjectivesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistObjectives.dat64");

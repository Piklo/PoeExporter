...
/// </summary>
public sealed partial class MapInhabitantsDat : ISpecificationFile<MapInhabitantsDat>
{
    ...
    /// <inheritdoc/>
    public static MapInhabitantsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MapInhabitants.dat64");

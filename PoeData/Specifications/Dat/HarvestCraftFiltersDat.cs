...
/// </summary>
public sealed partial class HarvestCraftFiltersDat : ISpecificationFile<HarvestCraftFiltersDat>
{
    ...
    public static HarvestCraftFiltersDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestCraftFilters.dat64");

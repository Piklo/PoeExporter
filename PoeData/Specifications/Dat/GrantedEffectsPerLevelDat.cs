...
/// </summary>
public sealed partial class GrantedEffectsPerLevelDat : IDat<GrantedEffectsPerLevelDat>
{
    ...
    /// <inheritdoc/>
    public static GrantedEffectsPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GrantedEffectsPerLevel.dat64");

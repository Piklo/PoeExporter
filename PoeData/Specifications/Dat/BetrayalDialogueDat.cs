...
/// </summary>
public sealed partial class BetrayalDialogueDat : ISpecificationFile<BetrayalDialogueDat>
{
    ...
    /// <inheritdoc/>
    public static BetrayalDialogueDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BetrayalDialogue.dat64");

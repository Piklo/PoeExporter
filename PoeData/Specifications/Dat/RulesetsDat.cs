...
/// <summary>
/// Class containing Rulesets.dat data.
/// </summary>
public sealed partial class RulesetsDat : ISpecificationFile<RulesetsDat>
{
    ...
    /// <inheritdoc/>
    public static RulesetsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Rulesets.dat64");

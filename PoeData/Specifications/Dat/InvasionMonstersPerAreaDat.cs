...
/// </summary>
public sealed partial class InvasionMonstersPerAreaDat : IDat<InvasionMonstersPerAreaDat>
{
    ...
    public static InvasionMonstersPerAreaDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/InvasionMonstersPerArea.dat64");

...
/// </summary>
public sealed partial class MTXSetBonusDat : ISpecificationFile<MTXSetBonusDat>
{
    ...
    /// <inheritdoc/>
    public static MTXSetBonusDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MTXSetBonus.dat64");

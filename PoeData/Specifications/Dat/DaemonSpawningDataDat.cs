...
/// </summary>
public sealed partial class DaemonSpawningDataDat : ISpecificationFile<DaemonSpawningDataDat>
{
    ...
    public static DaemonSpawningDataDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DaemonSpawningData.dat64");

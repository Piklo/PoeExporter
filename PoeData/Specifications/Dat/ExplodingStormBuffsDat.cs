...
/// </summary>
public sealed partial class ExplodingStormBuffsDat : ISpecificationFile<ExplodingStormBuffsDat>
{
    ...
    public static ExplodingStormBuffsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ExplodingStormBuffs.dat64");

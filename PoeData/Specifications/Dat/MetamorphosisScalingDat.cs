...
/// </summary>
public sealed partial class MetamorphosisScalingDat : ISpecificationFile<MetamorphosisScalingDat>
{
    ...
    public static MetamorphosisScalingDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MetamorphosisScaling.dat64");

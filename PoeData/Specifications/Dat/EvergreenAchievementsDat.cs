...
/// </summary>
public sealed partial class EvergreenAchievementsDat : ISpecificationFile<EvergreenAchievementsDat>
{
    ...
    public static EvergreenAchievementsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/EvergreenAchievements.dat64");

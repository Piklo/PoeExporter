...
/// </summary>
public sealed partial class EvergreenAchievementsDat
{
    ...
    /// <returns>array of EvergreenAchievementsDat.</returns>
    internal static EvergreenAchievementsDat[] Load(DataLoader dataLoader)
    {

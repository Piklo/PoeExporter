...
/// <summary>
/// Class containing HarvestStorageLayout.dat data.
/// </summary>
public sealed partial class HarvestStorageLayoutDat : ISpecificationFile<HarvestStorageLayoutDat>
{
    ...
    /// <summary> Gets ButtonHighlight.</summary>
    public required string ButtonHighlight { get; init; }
    ...
    public static HarvestStorageLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestStorageLayout.dat64");

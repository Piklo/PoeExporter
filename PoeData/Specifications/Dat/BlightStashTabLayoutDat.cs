...
/// </summary>
public sealed partial class BlightStashTabLayoutDat : ISpecificationFile<BlightStashTabLayoutDat>
{
    ...
    /// <inheritdoc/>
    public static BlightStashTabLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightStashTabLayout.dat64");

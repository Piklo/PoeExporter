...
/// </summary>
public sealed partial class AreaTransitionInfoDat
{
    ...
    /// <returns>array of AreaTransitionInfoDat.</returns>
    internal static AreaTransitionInfoDat[] Load(DataLoader dataLoader)
    {

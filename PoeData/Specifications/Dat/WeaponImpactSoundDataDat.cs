...
/// </summary>
public sealed partial class WeaponImpactSoundDataDat : ISpecificationFile<WeaponImpactSoundDataDat>
{
    ...
    public static WeaponImpactSoundDataDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/WeaponImpactSoundData.dat64");

...
/// <summary>
/// Class containing HarvestObjects.dat data.
/// </summary>
public sealed partial class HarvestObjectsDat : ISpecificationFile<HarvestObjectsDat>
{
    ...
    /// <inheritdoc/>
    public static HarvestObjectsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestObjects.dat64");

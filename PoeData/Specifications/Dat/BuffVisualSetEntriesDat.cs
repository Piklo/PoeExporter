...
/// </summary>
public sealed partial class BuffVisualSetEntriesDat : ISpecificationFile<BuffVisualSetEntriesDat>
{
    ...
    /// <inheritdoc/>
    public static BuffVisualSetEntriesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BuffVisualSetEntries.dat64");

...
/// </summary>
public sealed partial class HarvestCraftOptionIconsDat : ISpecificationFile<HarvestCraftOptionIconsDat>
{
    ...
    public static HarvestCraftOptionIconsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestCraftOptionIcons.dat64");

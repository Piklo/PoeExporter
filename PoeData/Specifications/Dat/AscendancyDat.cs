...
/// </summary>
public sealed partial class AscendancyDat : ISpecificationFile<AscendancyDat>
{
    ...
    /// <inheritdoc/>
    public static AscendancyDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Ascendancy.dat64");

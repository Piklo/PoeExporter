...
/// </summary>
public sealed partial class LabyrinthExclusionGroupsDat : ISpecificationFile<LabyrinthExclusionGroupsDat>
{
    ...
    public static LabyrinthExclusionGroupsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/LabyrinthExclusionGroups.dat64");

...
/// <summary>
/// Class containing BetrayalChoices.dat data.
/// </summary>
public sealed partial class BetrayalChoicesDat : ISpecificationFile<BetrayalChoicesDat>
{
    ...
    /// <inheritdoc/>
    public static BetrayalChoicesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BetrayalChoices.dat64");
        ...
        var objects = new BetrayalChoicesDat[tableRows];
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            var obj = new BetrayalChoicesDat()
            {
                Id = idLoading,
                Text = textLoading,

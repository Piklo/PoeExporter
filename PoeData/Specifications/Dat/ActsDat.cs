...
/// </summary>
public sealed partial class ActsDat : ISpecificationFile<ActsDat>
{
    ...
    /// <inheritdoc/>
    public static ActsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Acts.dat64");

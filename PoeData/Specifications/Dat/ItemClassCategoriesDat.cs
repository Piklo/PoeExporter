...
/// </summary>
public sealed partial class ItemClassCategoriesDat : ISpecificationFile<ItemClassCategoriesDat>
{
    ...
    /// <inheritdoc/>
    public static ItemClassCategoriesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ItemClassCategories.dat64");

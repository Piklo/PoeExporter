...
/// </summary>
public sealed partial class MonsterConditionsDat : ISpecificationFile<MonsterConditionsDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterConditionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterConditions.dat64");

...
/// <summary>
/// Class containing QuestType.dat data.
/// </summary>
public sealed partial class QuestTypeDat : ISpecificationFile<QuestTypeDat>
{
    ...
    /// <inheritdoc/>
    public static QuestTypeDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/QuestType.dat64");

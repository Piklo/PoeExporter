...
/// </summary>
public sealed partial class LegionRanksDat : ISpecificationFile<LegionRanksDat>
{
    ...
    /// <inheritdoc/>
    public static LegionRanksDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/LegionRanks.dat64");

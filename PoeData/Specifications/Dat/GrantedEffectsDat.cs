...
/// </summary>
public sealed partial class GrantedEffectsDat : ISpecificationFile<GrantedEffectsDat>
{
    ...
    /// <inheritdoc/>
    public static GrantedEffectsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GrantedEffects.dat64");

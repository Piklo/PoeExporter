...
/// </summary>
public sealed partial class EinharPackFallbackDat : ISpecificationFile<EinharPackFallbackDat>
{
    ...
    /// <inheritdoc/>
    public static EinharPackFallbackDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/EinharPackFallback.dat64");

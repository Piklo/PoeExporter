...
/// <summary>
/// Class containing ProphecyChain.dat data.
/// </summary>
public sealed partial class ProphecyChainDat : ISpecificationFile<ProphecyChainDat>
{
    ...
    public static ProphecyChainDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ProphecyChain.dat64");

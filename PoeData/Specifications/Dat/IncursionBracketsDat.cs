...
/// </summary>
public sealed partial class IncursionBracketsDat : ISpecificationFile<IncursionBracketsDat>
{
    ...
    public static IncursionBracketsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/IncursionBrackets.dat64");

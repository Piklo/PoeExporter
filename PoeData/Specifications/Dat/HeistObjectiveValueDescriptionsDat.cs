...
/// </summary>
public sealed partial class HeistObjectiveValueDescriptionsDat : ISpecificationFile<HeistObjectiveValueDescriptionsDat>
{
    ...
    public static HeistObjectiveValueDescriptionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistObjectiveValueDescriptions.dat64");

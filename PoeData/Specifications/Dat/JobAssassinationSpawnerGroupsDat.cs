...
/// </summary>
public sealed partial class JobAssassinationSpawnerGroupsDat : ISpecificationFile<JobAssassinationSpawnerGroupsDat>
{
    ...
    /// <inheritdoc/>
    public static JobAssassinationSpawnerGroupsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/JobAssassinationSpawnerGroups.dat64");

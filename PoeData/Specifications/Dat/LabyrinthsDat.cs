...
/// </summary>
public sealed partial class LabyrinthsDat : ISpecificationFile<LabyrinthsDat>
{
    ...
    public static LabyrinthsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Labyrinths.dat64");
        ...
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            // specification.GetLabyrinthTrialsDat();

...
/// </summary>
public sealed partial class ExpeditionMarkersCommonDat : ISpecificationFile<ExpeditionMarkersCommonDat>
{
    ...
    public static ExpeditionMarkersCommonDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ExpeditionMarkersCommon.dat64");

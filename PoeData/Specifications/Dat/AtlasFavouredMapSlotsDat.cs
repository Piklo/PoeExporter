...
/// </summary>
public sealed partial class AtlasFavouredMapSlotsDat
{
    ...
    /// <returns>array of AtlasFavouredMapSlotsDat.</returns>
    internal static AtlasFavouredMapSlotsDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class AlternateTreeVersionsDat : ISpecificationFile<AlternateTreeVersionsDat>
{
    ...
    public static AlternateTreeVersionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AlternateTreeVersions.dat64");

...
/// </summary>
public sealed partial class GrantedEffectQualityStatsDat : IDat<GrantedEffectQualityStatsDat>
{
    ...
    /// <inheritdoc/>
    public static GrantedEffectQualityStatsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GrantedEffectQualityStats.dat64");

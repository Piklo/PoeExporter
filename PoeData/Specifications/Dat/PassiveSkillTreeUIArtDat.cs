...
/// </summary>
public sealed partial class PassiveSkillTreeUIArtDat
{
    ...
    /// <returns>array of PassiveSkillTreeUIArtDat.</returns>
    internal static PassiveSkillTreeUIArtDat[] Load(DataLoader dataLoader)
    {

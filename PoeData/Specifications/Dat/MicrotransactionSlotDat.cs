...
/// </summary>
public sealed partial class MicrotransactionSlotDat : ISpecificationFile<MicrotransactionSlotDat>
{
    ...
    /// <inheritdoc/>
    public static MicrotransactionSlotDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MicrotransactionSlot.dat64");

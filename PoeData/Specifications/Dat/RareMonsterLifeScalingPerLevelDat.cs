...
/// </summary>
public sealed partial class RareMonsterLifeScalingPerLevelDat : ISpecificationFile<RareMonsterLifeScalingPerLevelDat>
{
    ...
    public static RareMonsterLifeScalingPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/RareMonsterLifeScalingPerLevel.dat64");

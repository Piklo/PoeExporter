...
/// </summary>
public sealed partial class AtlasAwakeningStatsDat : ISpecificationFile<AtlasAwakeningStatsDat>
{
    ...
    public static AtlasAwakeningStatsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AtlasAwakeningStats.dat64");

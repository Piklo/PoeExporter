...
/// </summary>
public sealed partial class DelveMonsterSpawnersDat : ISpecificationFile<DelveMonsterSpawnersDat>
{
    ...
    public static DelveMonsterSpawnersDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DelveMonsterSpawners.dat64");

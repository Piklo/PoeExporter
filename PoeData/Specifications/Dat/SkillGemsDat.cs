...
/// </summary>
public sealed partial class SkillGemsDat : IDat<SkillGemsDat>
{
    ...
    /// <inheritdoc/>
    public static SkillGemsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/SkillGems.dat64");

...
/// </summary>
public sealed partial class LevelRelativePlayerScalingDat
{
    ...
    /// <returns>array of LevelRelativePlayerScalingDat.</returns>
    internal static LevelRelativePlayerScalingDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class MonsterConditionalEffectPacksDat : ISpecificationFile<MonsterConditionalEffectPacksDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterConditionalEffectPacksDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterConditionalEffectPacks.dat64");

...
/// <summary>
/// Class containing ElderGuardians.dat data.
/// </summary>
public sealed partial class ElderGuardiansDat : ISpecificationFile<ElderGuardiansDat>
{
    ...
    public static ElderGuardiansDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ElderGuardians.dat64");

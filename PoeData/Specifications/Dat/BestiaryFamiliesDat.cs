...
/// </summary>
public sealed partial class BestiaryFamiliesDat : ISpecificationFile<BestiaryFamiliesDat>
{
    ...
    public static BestiaryFamiliesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BestiaryFamilies.dat64");

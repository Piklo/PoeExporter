...
/// </summary>
public sealed partial class HeistChokepointFormationDat : IDat<HeistChokepointFormationDat>
{
    ...
    public static HeistChokepointFormationDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistChokepointFormation.dat64");

...
/// <summary>
/// Class containing HarvestPerLevelValues.dat data.
/// </summary>
public sealed partial class HarvestPerLevelValuesDat : ISpecificationFile<HarvestPerLevelValuesDat>
{
    ...
    /// <inheritdoc/>
    public static HarvestPerLevelValuesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestPerLevelValues.dat64");

...
/// <summary>
/// Class containing DelveRewardTierConstants.dat data.
/// </summary>
public sealed partial class DelveRewardTierConstantsDat : ISpecificationFile<DelveRewardTierConstantsDat>
{
    ...
    /// <inheritdoc/>
    public static DelveRewardTierConstantsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DelveRewardTierConstants.dat64");

...
/// </summary>
public sealed partial class DelveRewardTierConstantsDat
{
    ...
    /// <returns>array of DelveRewardTierConstantsDat.</returns>
    internal static DelveRewardTierConstantsDat[] Load(DataLoader dataLoader)
    {

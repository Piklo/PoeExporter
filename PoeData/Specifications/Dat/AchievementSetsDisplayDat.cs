...
/// </summary>
public sealed partial class AchievementSetsDisplayDat : ISpecificationFile<AchievementSetsDisplayDat>
{
    ...
    public static AchievementSetsDisplayDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AchievementSetsDisplay.dat64");

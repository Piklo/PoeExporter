...
/// </summary>
public sealed partial class EffectivenessCostConstantsDat : ISpecificationFile<EffectivenessCostConstantsDat>
{
    ...
    public static EffectivenessCostConstantsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/EffectivenessCostConstants.dat64");

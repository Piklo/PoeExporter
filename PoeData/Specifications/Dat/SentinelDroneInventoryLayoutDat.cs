...
public sealed partial class SentinelDroneInventoryLayoutDat : ISpecificationFile<SentinelDroneInventoryLayoutDat>
{
    ...
    /// <inheritdoc/>
    public static SentinelDroneInventoryLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/SentinelDroneInventoryLayout.dat64");

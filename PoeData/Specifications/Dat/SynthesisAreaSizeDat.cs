...
/// </summary>
public sealed partial class SynthesisAreaSizeDat
{
    ...
    /// <returns>array of SynthesisAreaSizeDat.</returns>
    internal static SynthesisAreaSizeDat[] Load(DataLoader dataLoader)
    {

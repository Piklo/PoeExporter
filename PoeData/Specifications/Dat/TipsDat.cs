...
/// </summary>
public sealed partial class TipsDat : ISpecificationFile<TipsDat>
{
    ...
    /// <inheritdoc/>
    public static TipsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Tips.dat64");

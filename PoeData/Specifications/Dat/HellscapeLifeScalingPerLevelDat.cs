...
/// </summary>
public sealed partial class HellscapeLifeScalingPerLevelDat : ISpecificationFile<HellscapeLifeScalingPerLevelDat>
{
    ...
    public static HellscapeLifeScalingPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HellscapeLifeScalingPerLevel.dat64");

...
/// </summary>
public sealed partial class AlternateQualityCurrencyDecayFactorsDat : ISpecificationFile<AlternateQualityCurrencyDecayFactorsDat>
{
    ...
    public static AlternateQualityCurrencyDecayFactorsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AlternateQualityCurrencyDecayFactors.dat64");

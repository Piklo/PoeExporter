...
/// </summary>
public sealed partial class LegionBalancePerLevelDat
{
    ...
    /// <returns>array of LegionBalancePerLevelDat.</returns>
    internal static LegionBalancePerLevelDat[] Load(DataLoader dataLoader)
    {
        ...
        const string filePath = "Data/LegionBalancePerLevel.dat64";
        ...
        var objects = new LegionBalancePerLevelDat[tableRows];

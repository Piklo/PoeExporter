...
/// </summary>
public sealed partial class SentinelPowerExpLevelsDat
{
    ...
    /// <returns>array of SentinelPowerExpLevelsDat.</returns>
    internal static SentinelPowerExpLevelsDat[] Load(DataLoader dataLoader)
    {

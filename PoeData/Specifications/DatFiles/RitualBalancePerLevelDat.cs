...
/// </summary>
public sealed partial class RitualBalancePerLevelDat
{
    ...
    /// <returns>array of RitualBalancePerLevelDat.</returns>
    internal static RitualBalancePerLevelDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class MiscAnimatedArtVariationsDat
{
    ...
    /// <returns>array of MiscAnimatedArtVariationsDat.</returns>
    internal static MiscAnimatedArtVariationsDat[] Load(DataLoader dataLoader)
    {

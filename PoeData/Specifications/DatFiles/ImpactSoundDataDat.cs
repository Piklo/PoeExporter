...
/// </summary>
public sealed partial class ImpactSoundDataDat
{
    ...
    /// <returns>array of ImpactSoundDataDat.</returns>
    internal static ImpactSoundDataDat[] Load(DataLoader dataLoader)
    {

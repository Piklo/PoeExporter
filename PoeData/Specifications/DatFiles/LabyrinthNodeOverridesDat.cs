...
/// </summary>
public sealed partial class LabyrinthNodeOverridesDat
{
    ...
    /// <returns>array of LabyrinthNodeOverridesDat.</returns>
    internal static LabyrinthNodeOverridesDat[] Load(DataLoader dataLoader)
    {

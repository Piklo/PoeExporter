...
/// </summary>
public sealed partial class HarvestPerLevelValuesDat
{
    ...
    /// <returns>array of HarvestPerLevelValuesDat.</returns>
    internal static HarvestPerLevelValuesDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class BetrayalChoicesDat
{
    ...
    /// <returns>array of BetrayalChoicesDat.</returns>
    internal static BetrayalChoicesDat[] Load(DataLoader dataLoader)
    {
        ...
        const string filePath = "Data/BetrayalChoices.dat64";

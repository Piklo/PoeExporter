...
/// </summary>
public sealed partial class WorldAreaLeagueChancesDat
{
    ...
    /// <returns>array of WorldAreaLeagueChancesDat.</returns>
    internal static WorldAreaLeagueChancesDat[] Load(DataLoader dataLoader)
    {

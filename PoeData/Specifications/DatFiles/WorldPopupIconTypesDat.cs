...
/// </summary>
public sealed partial class WorldPopupIconTypesDat
{
    ...
    /// <returns>array of WorldPopupIconTypesDat.</returns>
    internal static WorldPopupIconTypesDat[] Load(DataLoader dataLoader)
    {

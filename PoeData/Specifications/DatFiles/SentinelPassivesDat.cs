...
/// </summary>
public sealed partial class SentinelPassivesDat
{
    ...
    /// <returns>array of SentinelPassivesDat.</returns>
    internal static SentinelPassivesDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class DelveFlaresDat
{
    ...
    /// <returns>array of DelveFlaresDat.</returns>
    internal static DelveFlaresDat[] Load(DataLoader dataLoader)
    {
        ...
        const string filePath = "Data/DelveFlares.dat64";

...
/// </summary>
public sealed partial class MetamorphosisStashTabLayoutDat
{
    ...
    /// <returns>array of MetamorphosisStashTabLayoutDat.</returns>
    internal static MetamorphosisStashTabLayoutDat[] Load(DataLoader dataLoader)
    {

...
/// </summary>
public sealed partial class PassiveSkillFilterOptionsDat
{
    ...
    /// <returns>array of PassiveSkillFilterOptionsDat.</returns>
    internal static PassiveSkillFilterOptionsDat[] Load(DataLoader dataLoader)
    {

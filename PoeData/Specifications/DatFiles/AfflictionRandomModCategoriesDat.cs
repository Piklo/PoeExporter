...
/// </summary>
public sealed partial class AfflictionRandomModCategoriesDat
{
    ...
    /// <returns>array of AfflictionRandomModCategoriesDat.</returns>
    internal static AfflictionRandomModCategoriesDat[] Load(DataLoader dataLoader)
    {

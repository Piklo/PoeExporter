...
/// </summary>
public sealed partial class HideoutDoodadCategoryDat
{
    ...
    /// <returns>array of HideoutDoodadCategoryDat.</returns>
    internal static HideoutDoodadCategoryDat[] Load(DataLoader dataLoader)
    {

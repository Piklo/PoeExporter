...
/// </summary>
public sealed partial class BuffVisualsArtVariationsDat
{
    ...
    /// <returns>array of BuffVisualsArtVariationsDat.</returns>
    internal static BuffVisualsArtVariationsDat[] Load(DataLoader dataLoader)
    {

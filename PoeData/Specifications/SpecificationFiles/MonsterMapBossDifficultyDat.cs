...
/// </summary>
public sealed partial class MonsterMapBossDifficultyDat : ISpecificationFile<MonsterMapBossDifficultyDat>
{
    ...
    public static MonsterMapBossDifficultyDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterMapBossDifficulty.dat64");

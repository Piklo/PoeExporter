...
/// </summary>
public sealed partial class MonsterPackCountsDat : ISpecificationFile<MonsterPackCountsDat>
{
    ...
    public static MonsterPackCountsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterPackCounts.dat64");

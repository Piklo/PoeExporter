...
/// </summary>
public sealed partial class AtlasFogDat : ISpecificationFile<AtlasFogDat>
{
    ...
    public static AtlasFogDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AtlasFog.dat64");
        ...
        var objects = new AtlasFogDat[tableRows];

...
/// </summary>
public sealed partial class StrDexIntMissionExtraRequirementDat : ISpecificationFile<StrDexIntMissionExtraRequirementDat>
{
    ...
    /// <inheritdoc/>
    public static StrDexIntMissionExtraRequirementDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/StrDexIntMissionExtraRequirement.dat64");

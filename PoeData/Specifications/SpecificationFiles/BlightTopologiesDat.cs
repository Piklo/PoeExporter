...
/// </summary>
public sealed partial class BlightTopologiesDat : ISpecificationFile<BlightTopologiesDat>
{
    ...
    /// <inheritdoc/>
    public static BlightTopologiesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightTopologies.dat64");

...
/// </summary>
public sealed partial class UltimatumEncountersDat : ISpecificationFile<UltimatumEncountersDat>
{
    ...
    public static UltimatumEncountersDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/UltimatumEncounters.dat64");

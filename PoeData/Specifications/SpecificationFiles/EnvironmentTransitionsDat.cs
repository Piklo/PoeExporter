...
/// </summary>
public sealed partial class EnvironmentTransitionsDat : ISpecificationFile<EnvironmentTransitionsDat>
{
    ...
    public static EnvironmentTransitionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/EnvironmentTransitions.dat64");

...
/// </summary>
public sealed partial class BestiaryRecipeCategoriesDat : ISpecificationFile<BestiaryRecipeCategoriesDat>
{
    ...
    /// <inheritdoc/>
    public static BestiaryRecipeCategoriesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BestiaryRecipeCategories.dat64");

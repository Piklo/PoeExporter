...
/// </summary>
public sealed partial class MonsterPacksDat : ISpecificationFile<MonsterPacksDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterPacksDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterPacks.dat64");

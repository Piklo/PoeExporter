...
/// </summary>
public sealed partial class StatDescriptionFunctionsDat : ISpecificationFile<StatDescriptionFunctionsDat>
{
    ...
    /// <inheritdoc/>
    public static StatDescriptionFunctionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/StatDescriptionFunctions.dat64");

...
/// </summary>
public sealed partial class NPCPortraitsDat : ISpecificationFile<NPCPortraitsDat>
{
    ...
    /// <inheritdoc/>
    public static NPCPortraitsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/NPCPortraits.dat64");

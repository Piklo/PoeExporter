...
public sealed partial class MetamorphosisMetaSkillTypesDat : ISpecificationFile<MetamorphosisMetaSkillTypesDat>
{
    ...
    /// <inheritdoc/>
    public static MetamorphosisMetaSkillTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MetamorphosisMetaSkillTypes.dat64");

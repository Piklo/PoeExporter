...
/// </summary>
public sealed partial class ArchetypeRewardsDat : ISpecificationFile<ArchetypeRewardsDat>
{
    ...
    /// <inheritdoc/>
    public static ArchetypeRewardsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ArchetypeRewards.dat64");

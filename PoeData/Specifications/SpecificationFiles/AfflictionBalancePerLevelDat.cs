...
/// </summary>
public sealed partial class AfflictionBalancePerLevelDat : ISpecificationFile<AfflictionBalancePerLevelDat>
{
    ...
    public required float Unknown56 { get; init; }

    /// <inheritdoc/>
    public static AfflictionBalancePerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AfflictionBalancePerLevel.dat64");

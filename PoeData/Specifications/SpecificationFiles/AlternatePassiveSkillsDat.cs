...
/// </summary>
public sealed partial class AlternatePassiveSkillsDat : ISpecificationFile<AlternatePassiveSkillsDat>
{
    ...
    public static AlternatePassiveSkillsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AlternatePassiveSkills.dat64");

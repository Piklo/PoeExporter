...
/// </summary>
public sealed partial class PassiveSkillTreesDat : ISpecificationFile<PassiveSkillTreesDat>
{
    ...
    public static PassiveSkillTreesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PassiveSkillTrees.dat64");

...
/// </summary>
public sealed partial class ActiveSkillsDat : ISpecificationFile<ActiveSkillsDat>
{
    ...
    public static ActiveSkillsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ActiveSkills.dat64");
        ...
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            // specification.GetAlternateSkillTargetingBehavioursDat();

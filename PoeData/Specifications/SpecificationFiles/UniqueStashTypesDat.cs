...
/// </summary>
public sealed partial class UniqueStashTypesDat : ISpecificationFile<UniqueStashTypesDat>
{
    ...
    public static UniqueStashTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/UniqueStashTypes.dat64");

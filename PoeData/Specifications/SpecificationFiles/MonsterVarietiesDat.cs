...
/// </summary>
public sealed partial class MonsterVarietiesDat : ISpecificationFile<MonsterVarietiesDat>
{
    ...
    public static MonsterVarietiesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterVarieties.dat64");

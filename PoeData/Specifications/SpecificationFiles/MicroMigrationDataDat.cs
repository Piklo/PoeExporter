...
/// </summary>
public sealed partial class MicroMigrationDataDat : ISpecificationFile<MicroMigrationDataDat>
{
    ...
    public static MicroMigrationDataDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MicroMigrationData.dat64");
        ...
        var objects = new MicroMigrationDataDat[tableRows];
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            var obj = new MicroMigrationDataDat()
            {

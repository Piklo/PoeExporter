...
public sealed partial class MicrotransactionPortalVariationsDat : ISpecificationFile<MicrotransactionPortalVariationsDat>
{
    ...
    /// <inheritdoc/>
    public static MicrotransactionPortalVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MicrotransactionPortalVariations.dat64");

...
/// </summary>
public sealed partial class PackFormationDat : ISpecificationFile<PackFormationDat>
{
    ...
    /// <inheritdoc/>
    public static PackFormationDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PackFormation.dat64");

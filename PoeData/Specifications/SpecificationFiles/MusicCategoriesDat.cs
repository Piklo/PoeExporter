...
/// </summary>
public sealed partial class MusicCategoriesDat : ISpecificationFile<MusicCategoriesDat>
{
    ...
    /// <inheritdoc/>
    public static MusicCategoriesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MusicCategories.dat64");

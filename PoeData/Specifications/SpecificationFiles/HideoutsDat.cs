...
/// </summary>
public sealed partial class HideoutsDat : ISpecificationFile<HideoutsDat>
{
    ...
    /// <inheritdoc/>
    public static HideoutsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Hideouts.dat64");

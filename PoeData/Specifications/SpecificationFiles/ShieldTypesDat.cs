...
/// <summary>
/// Class containing ShieldTypes.dat data.
/// </summary>
public sealed partial class ShieldTypesDat : ISpecificationFile<ShieldTypesDat>
{
    ...
    public static ShieldTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ShieldTypes.dat64");

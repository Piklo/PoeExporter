...
/// </summary>
public sealed partial class HideoutDoodadTagsDat : ISpecificationFile<HideoutDoodadTagsDat>
{
    ...
    /// <inheritdoc/>
    public static HideoutDoodadTagsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HideoutDoodadTags.dat64");

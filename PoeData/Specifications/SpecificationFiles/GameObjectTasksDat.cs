...
/// </summary>
public sealed partial class GameObjectTasksDat : ISpecificationFile<GameObjectTasksDat>
{
    ...
    /// <inheritdoc/>
    public static GameObjectTasksDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/GameObjectTasks.dat64");

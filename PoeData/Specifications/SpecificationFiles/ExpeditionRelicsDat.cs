...
/// </summary>
public sealed partial class ExpeditionRelicsDat : ISpecificationFile<ExpeditionRelicsDat>
{
    ...
    public static ExpeditionRelicsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/ExpeditionRelics.dat64");

...
/// </summary>
public sealed partial class HarvestSpecialCraftOptionsDat : ISpecificationFile<HarvestSpecialCraftOptionsDat>
{
    ...
    /// <inheritdoc/>
    public static HarvestSpecialCraftOptionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestSpecialCraftOptions.dat64");

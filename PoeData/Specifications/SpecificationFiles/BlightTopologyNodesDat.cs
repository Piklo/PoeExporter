...
/// </summary>
public sealed partial class BlightTopologyNodesDat : ISpecificationFile<BlightTopologyNodesDat>
{
    ...
    /// <inheritdoc/>
    public static BlightTopologyNodesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightTopologyNodes.dat64");

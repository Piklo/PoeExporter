...
/// </summary>
public sealed partial class DescentRewardChestsDat : ISpecificationFile<DescentRewardChestsDat>
{
    ...
    public static DescentRewardChestsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DescentRewardChests.dat64");

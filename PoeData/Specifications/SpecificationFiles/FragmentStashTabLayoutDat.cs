...
/// </summary>
public sealed partial class FragmentStashTabLayoutDat : ISpecificationFile<FragmentStashTabLayoutDat>
{
    ...
    public static FragmentStashTabLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/FragmentStashTabLayout.dat64");

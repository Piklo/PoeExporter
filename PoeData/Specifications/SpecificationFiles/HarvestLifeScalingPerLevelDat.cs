...
/// </summary>
public sealed partial class HarvestLifeScalingPerLevelDat : ISpecificationFile<HarvestLifeScalingPerLevelDat>
{
    ...
    /// <inheritdoc/>
    public static HarvestLifeScalingPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HarvestLifeScalingPerLevel.dat64");

...
/// <summary>
/// Class containing AtlasFavouredMapSlots.dat data.
/// </summary>
public sealed partial class AtlasFavouredMapSlotsDat : ISpecificationFile<AtlasFavouredMapSlotsDat>
{
    ...
    /// <summary> Gets Requirement.</summary>
    public required string Requirement { get; init; }

    /// <inheritdoc/>
    public static AtlasFavouredMapSlotsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AtlasFavouredMapSlots.dat64");

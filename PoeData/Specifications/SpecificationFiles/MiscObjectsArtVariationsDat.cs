...
/// <summary>
/// Class containing MiscObjectsArtVariations.dat data.
/// </summary>
public sealed partial class MiscObjectsArtVariationsDat : ISpecificationFile<MiscObjectsArtVariationsDat>
{
    ...
    /// <inheritdoc/>
    public static MiscObjectsArtVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MiscObjectsArtVariations.dat64");
        ...
        var objects = new MiscObjectsArtVariationsDat[tableRows];
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            var obj = new MiscObjectsArtVariationsDat()
            {

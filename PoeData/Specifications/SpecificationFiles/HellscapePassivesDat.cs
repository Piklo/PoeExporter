...
/// </summary>
public sealed partial class HellscapePassivesDat : ISpecificationFile<HellscapePassivesDat>
{
    ...
    /// <inheritdoc/>
    public static HellscapePassivesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HellscapePassives.dat64");

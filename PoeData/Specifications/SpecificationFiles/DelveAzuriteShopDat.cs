...
/// </summary>
public sealed partial class DelveAzuriteShopDat : ISpecificationFile<DelveAzuriteShopDat>
{
    ...
    public static DelveAzuriteShopDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DelveAzuriteShop.dat64");

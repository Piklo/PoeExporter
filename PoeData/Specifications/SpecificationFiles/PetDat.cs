...
/// </summary>
public sealed partial class PetDat : ISpecificationFile<PetDat>
{
    ...
    /// <inheritdoc/>
    public static PetDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Pet.dat64");

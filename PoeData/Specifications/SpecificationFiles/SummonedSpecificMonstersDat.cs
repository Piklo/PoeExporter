...
/// </summary>
public sealed partial class SummonedSpecificMonstersDat : ISpecificationFile<SummonedSpecificMonstersDat>
{
    ...
    public static SummonedSpecificMonstersDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/SummonedSpecificMonsters.dat64");

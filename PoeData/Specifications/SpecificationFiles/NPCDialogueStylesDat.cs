...
/// </summary>
public sealed partial class NPCDialogueStylesDat : ISpecificationFile<NPCDialogueStylesDat>
{
    ...
    /// <inheritdoc/>
    public static NPCDialogueStylesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/NPCDialogueStyles.dat64");

...
/// </summary>
public sealed partial class LabyrinthSecretsDat : ISpecificationFile<LabyrinthSecretsDat>
{
    ...
    public static LabyrinthSecretsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/LabyrinthSecrets.dat64");

...
/// </summary>
public sealed partial class MonsterSpawnerGroupsDat : ISpecificationFile<MonsterSpawnerGroupsDat>
{
    ...
    public static MonsterSpawnerGroupsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterSpawnerGroups.dat64");

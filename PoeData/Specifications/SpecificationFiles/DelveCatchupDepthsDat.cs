...
/// </summary>
public sealed partial class DelveCatchupDepthsDat : ISpecificationFile<DelveCatchupDepthsDat>
{
    ...
    public static DelveCatchupDepthsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DelveCatchupDepths.dat64");

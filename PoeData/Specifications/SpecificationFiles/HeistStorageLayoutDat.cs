...
/// </summary>
public sealed partial class HeistStorageLayoutDat : ISpecificationFile<HeistStorageLayoutDat>
{
    ...
    public static HeistStorageLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistStorageLayout.dat64");

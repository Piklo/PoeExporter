...
/// </summary>
public sealed partial class ModsDat : ISpecificationFile<ModsDat>
{
    ...
    /// <inheritdoc/>
    public static ModsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/Mods.dat64");

...
/// </summary>
public sealed partial class HeistValueScalingDat : ISpecificationFile<HeistValueScalingDat>
{
    ...
    public static HeistValueScalingDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/HeistValueScaling.dat64");

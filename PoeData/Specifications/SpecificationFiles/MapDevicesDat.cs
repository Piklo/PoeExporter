...
/// </summary>
public sealed partial class MapDevicesDat : ISpecificationFile<MapDevicesDat>
{
    ...
    /// <inheritdoc/>
    public static MapDevicesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MapDevices.dat64");

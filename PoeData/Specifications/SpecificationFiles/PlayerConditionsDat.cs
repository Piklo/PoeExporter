...
/// </summary>
public sealed partial class PlayerConditionsDat : ISpecificationFile<PlayerConditionsDat>
{
    ...
    public static PlayerConditionsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PlayerConditions.dat64");

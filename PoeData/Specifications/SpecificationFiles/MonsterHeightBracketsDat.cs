...
/// </summary>
public sealed partial class MonsterHeightBracketsDat : ISpecificationFile<MonsterHeightBracketsDat>
{
    ...
    public static MonsterHeightBracketsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterHeightBrackets.dat64");

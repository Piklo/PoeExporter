...
/// </summary>
public sealed partial class PantheonPanelLayoutDat : ISpecificationFile<PantheonPanelLayoutDat>
{
    ...
    /// <inheritdoc/>
    public static PantheonPanelLayoutDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/PantheonPanelLayout.dat64");
        ...
        for (var rowId = 0; rowId < tableRows; rowId++)
        {
            ...
            // specification.GetQuestStatesDat();

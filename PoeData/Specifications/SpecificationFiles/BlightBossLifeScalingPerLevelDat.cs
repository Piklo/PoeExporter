...
/// </summary>
public sealed partial class BlightBossLifeScalingPerLevelDat : ISpecificationFile<BlightBossLifeScalingPerLevelDat>
{
    ...
    /// <inheritdoc/>
    public static BlightBossLifeScalingPerLevelDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightBossLifeScalingPerLevel.dat64");

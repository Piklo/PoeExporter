...
/// <summary>
/// Class containing BlightCraftingTypes.dat data.
/// </summary>
public sealed partial class BlightCraftingTypesDat : ISpecificationFile<BlightCraftingTypesDat>
{
    ...
    public static BlightCraftingTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/BlightCraftingTypes.dat64");

...
/// <summary>
/// Class containing MicrotransactionCursorVariations.dat data.
/// </summary>
public sealed partial class MicrotransactionCursorVariationsDat : ISpecificationFile<MicrotransactionCursorVariationsDat>
{
    ...
    public static MicrotransactionCursorVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MicrotransactionCursorVariations.dat64");

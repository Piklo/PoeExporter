...
/// </summary>
public sealed partial class MiscEffectPacksArtVariationsDat : ISpecificationFile<MiscEffectPacksArtVariationsDat>
{
    ...
    public static MiscEffectPacksArtVariationsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MiscEffectPacksArtVariations.dat64");

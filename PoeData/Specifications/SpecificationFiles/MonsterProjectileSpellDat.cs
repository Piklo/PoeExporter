...
/// </summary>
public sealed partial class MonsterProjectileSpellDat : ISpecificationFile<MonsterProjectileSpellDat>
{
    ...
    public static MonsterProjectileSpellDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterProjectileSpell.dat64");

...
/// </summary>
public sealed partial class TriggerBeamDat : ISpecificationFile<TriggerBeamDat>
{
    ...
    /// <inheritdoc/>
    public static TriggerBeamDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/TriggerBeam.dat64");

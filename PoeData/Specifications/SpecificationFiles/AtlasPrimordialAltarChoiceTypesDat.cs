...
/// </summary>
public sealed partial class AtlasPrimordialAltarChoiceTypesDat : ISpecificationFile<AtlasPrimordialAltarChoiceTypesDat>
{
    ...
    public static AtlasPrimordialAltarChoiceTypesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/AtlasPrimordialAltarChoiceTypes.dat64");

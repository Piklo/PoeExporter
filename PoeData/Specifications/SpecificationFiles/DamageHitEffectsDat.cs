...
/// </summary>
public sealed partial class DamageHitEffectsDat : ISpecificationFile<DamageHitEffectsDat>
{
    ...
    public static DamageHitEffectsDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/DamageHitEffects.dat64");

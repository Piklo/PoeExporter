...
/// </summary>
public sealed partial class MonsterResistancesDat : ISpecificationFile<MonsterResistancesDat>
{
    ...
    /// <inheritdoc/>
    public static MonsterResistancesDat[] Load(Specification specification)
    {
        ...
        var fileToFind = Encoding.ASCII.GetBytes("Data/MonsterResistances.dat64");
